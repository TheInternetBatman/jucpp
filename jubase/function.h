...
namespace ju{
	...
	//delegate////////////////////
	template<typename T1 = NullType,typename T2 = NullType,typename T3 = NullType,typename T4 = NullType,typename T5 = NullType,typename T6 = NullType,typename T7 = NullType,typename T8 = NullType,typename T9 = NullType,typename T10 = NullType> class JUBASETL_API Delegate : public _delegate{
	public:
	...
	template<typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7,typename T8,typename T9> class JUBASETL_API Delegate<T1,T2,T3,T4,T5,T6,T7,T8,T9> : public _delegate{
	public:
	...
	template<typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7,typename T8> class JUBASETL_API Delegate<T1,T2,T3,T4,T5,T6,T7,T8> : public _delegate{
	public:
	...
	template<typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7> class JUBASETL_API Delegate<T1,T2,T3,T4,T5,T6,T7> : public _delegate{
	public:
	...
	template<typename T1,typename T2,typename T3,typename T4,typename T5,typename T6> class JUBASETL_API Delegate<T1,T2,T3,T4,T5,T6> : public _delegate{
	public:
	...
	template<typename T1,typename T2,typename T3,typename T4,typename T5> class JUBASETL_API Delegate<T1,T2,T3,T4,T5> : public _delegate{
	public:
	...
	template<typename T1,typename T2,typename T3,typename T4> class JUBASETL_API Delegate<T1,T2,T3,T4> : public _delegate{
	public:
	...
	template<typename T1,typename T2,typename T3> class JUBASETL_API Delegate<T1,T2,T3> : public _delegate{
	public:
	...
	template<typename T1,typename T2> class JUBASETL_API Delegate<T1,T2> : public _delegate{
	public:
	...
	template<typename T1> class JUBASETL_API Delegate<T1> : public _delegate{
	public:
	...
	template<> class JUBASETL_API Delegate<> : public _delegate{
	public:
