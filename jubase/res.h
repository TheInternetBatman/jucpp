...
namespace ju{
	...
	typedef struct JUBASE_API ResID : public _class{
		HINSTANCE	Instance;
		LPCWSTR		Handle;
	...
	//赋值的原字串。
	class JUBASE_API  ResName : public _class
	{
	protected:
		LPCWSTR _Handle;
	public:
	...
	JUBASE_API void* GetResource(ResID name,ResID type,DWORD* size = 0);
	...
	后者生成一个子菜单;*/
	class JUBASE_API  Menu : public HandleType<HMENU>
	{
	public:
		Menu();
		~Menu();
