#pragma once
namespace ju{
	class JUBASE_API Md5 : public _class{
	protected:
		void* _md5_ctx;
	public:
		Md5();
	...
	class JUBASE_API Md5Hmac : public _class{
	protected:
		void* _md5_ctx;
	public:
		Md5Hmac();
	...
	class JUBASE_API Sha : public _class{
	protected:
		void*	_sha_ctx;
		uint	_bits;
	public:
	...
	class JUBASE_API Aes : public _class{
	protected:
		void* _aes_ctx;
		char _iv[16];
	...
	public:
		...
		@return void
		@text 没有返回值。*/
		void EncryptEcb(void* out16,const void* in16);
		...
		@return void
		@text 没有返回值。*/
		void DecryptEcb(void* out16,const void* in16);
