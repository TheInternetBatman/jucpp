...
namespace ju{
	...
	template<typename T> class JUBASETL_API List : public _class{
	protected:
		uint _Count,		//元素数量.
	...
	template<typename T> class JUBASETL_API IntegerList : public List<T>{
	public:
		IntegerList(){
	...
	template<typename T> class JUBASETL_API IntegerDiction : public IntegerList<T>{
	public:
	...
	template<typename T> class JUBASETL_API ObjectList : public _class{
	protected:
		IntegerList<T*> _Ptrs;
	public:
		inline ObjectList(){
...
#define LINK_LAST		2
	template<typename T> class JUBASETL_API ObjectLink : public _class{
	protected:
		template<typename T> class JUBASETL_API  _Link : public _class{
		public:
			T* handle;
			_Link* previous,*next;
			_Link(){
