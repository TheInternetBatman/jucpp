...
namespace ju{
	...
	interface JUWND_API ButtonPtr : virtual public WndPtr{
	public:
		ButtonPtr(){}
	...
	interface JUWND_API ListBoxPtr : virtual public WndPtr{
	public:
		ListBoxPtr(){}
	...
	interface JUWND_API LabelPtr : virtual public WndPtr
	{
	public:
		LabelPtr(){}
	...
	//Edit Control
	interface JUWND_API EditPtr : virtual public WndPtr
	{
	public:
		EditPtr(){}
	...
	interface JUWND_API DateTimePickerPtr : virtual public WndPtr
	{
	public:
		DateTimePickerPtr(){}
	...
	//Calendar Control
	interface JUWND_API MonthCalendarPtr : virtual public WndPtr
	{
	public:
		MonthCalendarPtr(){}
	...
	interface JUWND_API ComboBoxPtr : virtual public WndPtr
	{
	public:
		ComboBoxPtr(){}
	...
	interface JUWND_API ComboBoxExPtr : virtual public WndPtr//ComboBoxEx不支持搜索字串有关的函数.
	{
	public:
		ComboBoxExPtr(){}
	...
	interface JUWND_API TreeViewPtr : virtual public WndPtr
	{
	public:
		TreeViewPtr(){}
	...
	interface JUWND_API ToolBarPtr : virtual public WndPtr
	{
	public:
		ToolBarPtr(){}
	...
	//ProgressBar Control
	interface JUWND_API ProgressBarPtr : virtual public WndPtr
	{
	public:
		ProgressBarPtr(){}
	...
	interface JUWND_API ToolTipPtr : virtual public WndPtr
	{
	public:
		ToolTipPtr(){}
	...
	interface JUWND_API TabPagePtr : virtual public WndPtr
	{
	public:
		TabPagePtr(){}
	...
	//表示组合键的一个结构.
	//热键控件
	interface JUWND_API HotKeyPtr : virtual public WndPtr
	{
	public:
		HotKeyPtr(){}
	...
	interface JUWND_API RebarPtr : virtual public WndPtr{
		RebarPtr(){}
		RebarPtr(HWND ctrl){_Handle = ctrl;}
		void operator = (HWND ctrl){_Handle = ctrl;}
	};
	interface JUWND_API ListViewPtr : virtual public WndPtr
	{
	public:
		ListViewPtr(){}
		...
		//设置绑定到项的数据
		bool SetItemData(int index,void* data);
		...
		//设置项的图标，对于report风格的listview，只有第一列可以设置图标，所以无需知道列索引，需要预先设置 LVSIL_SMALL 的 ImageList。
		LRESULT SetItemImage(int iItem,int iImage);
		//
		HIMAGELIST SetReportImageList(HIMAGELIST hil){
			return ListView_SetImageList(_Handle,hil,LVSIL_SMALL);
		}
		//
	};
	interface JUWND_API StatusBarPtr : virtual public WndPtr
	{
	public:
		StatusBarPtr(){};
	...
	interface JUWND_API UpDownPtr : virtual public WndPtr
	{
	public:
		UpDownPtr(){}
	...
	interface JUWND_API TrackBarPtr : virtual public WndPtr
	{
		TrackBarPtr(){}
	...
	interface JUWND_API HeaderPtr : virtual public WndPtr{
		HeaderPtr(){}
	...
	interface JUWND_API LinkPtr : virtual public WndPtr{
		LinkPtr(){}
		LinkPtr(HWND ctrl){_Handle = ctrl;}
		void operator = (HWND ctrl){_Handle = ctrl;}
	};
	interface JUWND_API IpAddressPtr : virtual public WndPtr{
		IpAddressPtr(){}
