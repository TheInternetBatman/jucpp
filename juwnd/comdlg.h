...
namespace ju{
	class JUWND_API  FolderDialog : public _class
	{
	protected:
	...
	class JUWND_API  FileDialog : public HandleType<HWND>
	{
	protected:
	...
	//颜色对话框.
	class JUWND_API  ColorDialog : public _class
	{
	public:
	...
	class JUWND_API  FontDialog : public _class
	{
	protected:
		wchar_t mStyle[4];
