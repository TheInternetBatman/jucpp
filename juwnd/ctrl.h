...
namespace ju{
	...
	JUWND_API bool InitControl60(DWORD icc = ICC_WIN95_CLASSES);
	//ImageList管理图标或图像,它主要用于其它控件使用的图像源.
	class JUWND_API  ImageList : public HandleType<HIMAGELIST>{
	public:
		~ImageList();
		//绑定一个HIMAGELIST句柄.
	...
	class JUWND_API  ICtrl : public IWnd{
	protected:
		//截取控件消息的回调函数.
	...
	JUWND_API ICtrl* GetICtrl(HWND hWnd);
	...
	//class Label
	class JUWND_API  Label : public ICtrl,public LabelPtr
	{
	public:
	...
	*/
	class JUWND_API  Button : public ICtrl,public ButtonPtr
	{
	public:
		void operator = (HWND hWnd){Attach(hWnd);}
		Button();
	};
	class JUWND_API  GroupBox : public ICtrl,public ButtonPtr
	{
	public:
		void operator = (HWND hWnd){Attach(hWnd);}
		GroupBox();
	};
	class JUWND_API  CheckBox : public ICtrl,public ButtonPtr
	{
	public:
		void operator = (HWND hWnd){Attach(hWnd);}
		CheckBox();
	};
	class JUWND_API  Radio : public ICtrl,public ButtonPtr
	{
	public:
		void operator = (HWND hWnd){Attach(hWnd);}
		Radio();
	...
	//Edit Control
	class JUWND_API  Edit : public ICtrl,public EditPtr{
		void _CtrlColor(Message*,ICtrl*);
	...
	class JUWND_API  DateTimePicker : public ICtrl,public DateTimePickerPtr
	{
	public:
		void operator = (HWND hWnd){Attach(hWnd);}
		DateTimePicker();
	...
	//Calendar Control
	class JUWND_API  MonthCalendar : public ICtrl,public MonthCalendarPtr
	{
	public:
		MonthCalendar();
		void operator = (HWND hWnd){Attach(hWnd);}
	...
	class JUWND_API  ListBox : public ICtrl,public ListBoxPtr
	{
	public:
		ListBox();
		void operator = (HWND hWnd){Attach(hWnd);}
	...
	class JUWND_API  ComboBox : public ICtrl,public ComboBoxPtr
	{
	public:
		ComboBox();
		void operator = (HWND hWnd){Attach(hWnd);}
	...
	class JUWND_API  ComboBoxEx : public ICtrl,public ComboBoxExPtr//ComboBoxEx不支持搜索字串有关的函数.
	{
	public:
		ComboBoxEx();
		void operator = (HWND hWnd){Attach(hWnd);}
	...
	class JUWND_API  TreeView : public ICtrl,public TreeViewPtr
	{
	public:
		void operator = (HWND hWnd){Attach(hWnd);}
	...
	class JUWND_API  ToolBar : public ICtrl,public ToolBarPtr{
	public:
		void operator = (HWND hWnd){Attach(hWnd);}
		ToolBar();
		//生成控件.
	...
	//ProgressBar Control
	class JUWND_API  ProgressBar : public ICtrl,public ProgressBarPtr
	{
	public:
		void operator = (HWND hWnd){Attach(hWnd);}
		ProgressBar();
	};
	class JUWND_API Rebar : public ICtrl,public RebarPtr{
	public:
		void operator = (HWND hWnd){Attach(hWnd);}
		Rebar();
	};
	//ToolTip Control 这个控件必须在启用6.0版本控件时才可用.也就是说,必须要有MANIFEST.
	class JUWND_API  ToolTip : public ICtrl,public ToolTipPtr
	{
	public:
		void operator = (HWND hWnd){Attach(hWnd);}
		ToolTip(void);
	...
	class JUWND_API  TabPage : public ICtrl,public TabPagePtr
	{
	public:
		void operator = (HWND hWnd){Attach(hWnd);}
		TabPage();
	...
	//表示组合键的一个结构.
	//热键控件
	class JUWND_API  HotKey : public ICtrl,public HotKeyPtr
	{
	public:
		void operator = (HWND hWnd){Attach(hWnd);}
		HotKey();
	};
	class JUWND_API  ListView : public ICtrl,public ListViewPtr
	{
	public:
		void operator = (HWND hWnd){Attach(hWnd);}
		ListView();
	...
	class JUWND_API  StatusBar : public ICtrl,public StatusBarPtr
	{
	public:
		void operator = (HWND hWnd){Attach(hWnd);}
		StatusBar();
	};
	class JUWND_API  TrackBar : public ICtrl,public TrackBarPtr
	{
	public:
		void operator = (HWND hWnd){Attach(hWnd);}
		TrackBar();
	...
	class JUWND_API  UpDown : public ICtrl,public UpDownPtr
	{
	public:
		void operator = (HWND hWnd){Attach(hWnd);}
		UpDown();
	...
	class JUWND_API Header : public ICtrl,public HeaderPtr{
	public:
		void operator = (HWND hWnd){Attach(hWnd);}
		Header();
	};
	class JUWND_API Link : public ICtrl,public LinkPtr{
	public:
		void operator = (HWND hWnd){Attach(hWnd);}
		Link();
	};
	class JUWND_API IpAddress : public ICtrl,public IpAddressPtr{
	public:
		void operator = (HWND hWnd){Attach(hWnd);}
		IpAddress();
	};
